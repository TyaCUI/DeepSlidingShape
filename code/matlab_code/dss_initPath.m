function opt = dss_initPath()
            ...
            opt.cudnn_libpath       = '/home/tianyi.cui/my_cuda/cuda-7.5/lib64';
            
            %% locations to save: data,feature, trained model and snapshot, training log
            localdata_root          = '/home/tianyi.cui/rgb_d/deepDetectLocal/';
            ...
            rootpath = '/home/tianyi.cui/rgb_d/DeepSlidingShape/';
